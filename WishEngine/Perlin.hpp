...
namespace Wish
{
	...
	public:
		...
		PerlinNoise(int _seed, double _persistence = 1.1, double _frequency = 0.005, double _amplitude = 2, int _octaves = 6) :
			seed(_seed),
		...
		double linearInterpolate(double p1, double p2, double weight)
		{
